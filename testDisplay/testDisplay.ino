...
void loop () {
  ...
  delay(1000); // 3
  processPayload(0b10111100, 0b11011110, 0b11111111, 0b00000001, 0b00000000, 0b00010000, 0b10110101, 0b10000110, 0b11000001, 0b11100000, 0b00000001, 0b00000000); // 00100001
  delay(1000); // 4
  processPayload(0b11011000, 0b11101100, 0b11111111, 0b00000111, 0b00000000, 0b00010000, 0b10110001, 0b10001110, 0b11000011, 0b11100001, 0b00000011, 0b0000000);
  delay(1000); // 5
